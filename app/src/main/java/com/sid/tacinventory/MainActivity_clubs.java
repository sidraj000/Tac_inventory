...
public class MainActivity_clubs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_clubs);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.logout_menu:
                ...
                startActivity(new Intent(MainActivity_clubs.this,LoginActivity.class));
                finish();
                return true;
            default:
    ...
    public void onBackPressed() {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(MainActivity_clubs.this);
